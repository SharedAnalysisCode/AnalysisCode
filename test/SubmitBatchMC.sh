...
do
    ...
    for dataset in $(ls "/gpfs_data/local/atlas/ucchielli/ExoticNtuples/v1/MC/$file")
    do
	...
	echo "file is $file" 
        bsub -q $QUEUE -e err -o out python ${INSCRIPT}/${SCRIPT} --input ${INFILES}/$file/$dataset --sampletype="mc" #--events=20000 #--config="sys:FF_DN"
