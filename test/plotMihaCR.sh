...
python ../ssdilep/scripts/merge.py --var="el_lead_phi" --reg="opposite-sign-CR" --lab="" --tag="OSCR" --icut="1" --input="/ceph/grid/home/atlas/miham/AnalysisCode/CRelectron3" --output="./Plots" --makeplot=True --fakest="FakeFactor"
python ../ssdilep/scripts/merge.py --var="el_sublead_phi" --reg="opposite-sign-CR" --lab="" --tag="OSCR" --icut="1" --input="/ceph/grid/home/atlas/miham/AnalysisCode/CRelectron3" --output="./Plots" --makeplot=True --fakest="FakeFactor"
