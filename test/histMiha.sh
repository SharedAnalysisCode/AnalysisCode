...
# python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/PowhegPythiaEvtGen_P2012_ttbar_hdamp172p5_dil.root --sampletype="mc" --config="min_entry:0,max_entry:-1"   #--config="sys:FF_DN" 
 ...
 # python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/Sherpa_CT10_llll.root --sampletype="mc" --config="min_entry:0,max_entry:5000"   #--config="sys:FF_DN" 
#python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/00300800.physics_Main.root --sampletype="data" --config="min_entry:0,max_entry:-1,sys:FF_DN"
