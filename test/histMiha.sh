...
# python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/Sherpa_222_NNPDF30NNLO_lvvv.root --sampletype="mc" --config="min_entry:0,max_entry:50,sys:MUR1_MUF1_PDF261100"   #--config="sys:FF_DN" 
 ...
 # python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/MadGraphPythia8EvtGen_A14NNPDF23LO_LRSM_WR3000_NR1800.root --sampletype="mc" --config="min_entry:0,max_entry:-1"   #--config="sys:FF_DN" 
