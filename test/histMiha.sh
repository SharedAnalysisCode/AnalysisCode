...
# python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/Sherpa_221_NNPDF30NNLO_Zee_MAXHTPTV0_70_CVetoBVeto.root --sampletype="mc" --config="min_entry:0,max_entry:10000"   #--config="sys:FF_DN" 
 python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/Sherpa_221_NNPDF30NNLO_Zee_MAXHTPTV280_500_CFilterBVeto.root --sampletype="mc" --config="min_entry:0,max_entry:100000"   #--config="sys:FF_DN" 
