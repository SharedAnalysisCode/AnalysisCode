...
# python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/PowhegPythia8EvtGen_AZNLOCTEQ6L1_DYee_5000M.root --sampletype="mc" --config="min_entry:1000,max_entry:10000"   #--config="sys:FF_DN" 
 python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/PowhegPythia8EvtGen_AZNLOCTEQ6L1_DYee_120M180.root --sampletype="mc" --config="min_entry:1000,max_entry:10000"   #--config="sys:FF_DN" 
# python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/PowhegPythiaEvtGen_P2012_ttbar_hdamp172p5_dil.root --sampletype="mc" --config="min_entry:1000,max_entry:10000"   #--config="sys:FF_DN" 
#python ${INSCRIPT}/${SCRIPT} --input ${INPATH}/00299055.physics_Main.root --sampletype="data" --config="min_entry:0,max_entry:100000"
